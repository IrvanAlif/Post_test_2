...
Di bagian ini, pengguna berhasil login sebagai Regular User dan milih menu Tambah Tanaman. Pengguna ngisi data tanaman baru mulai dari nama tanaman (bayam), jenis tanaman (sayuran), sistem hidroponik yang dipakai (NFT), tanggal tanam, status tanaman (bibit), pH air, sampai catatan tambahan. Setelah semua data dimasukin, sistem konfirmasi dengan pesan kalau tanaman berhasil ditambahkan ke database.
...
Tampilan ini nunjukin saat pengguna milih menu Lihat Semua Tanaman. Sistem langsung nampilin daftar tanaman yang udah ditambah sebelumnya, lengkap dengan detailnya. Contohnya ada tanaman bayam dengan jenis sayuran, sistem hidroponik NFT, tanggal tanam 12/2/2025, status Bibit, pH air 12, dan catatan efgggdgd.
