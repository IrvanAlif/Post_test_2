...
// Method untuk export data (simulasi)
public void exportData() {
    if(daftarTanaman.isEmpty()) {
        System.out.println("Belum ada tanaman untuk diexport.");
        return;
    }
    
    System.out.println("=== EXPORT DATA ===");
    System.out.println("Data berhasil diexport ke file: tanaman_hidroponik_" + 
                       java.time.LocalDateTime.now().format(
                           java.time.format.DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")) + ".txt");
    
    // Simulasi export - dalam implementasi nyata bisa menulis ke file
    System.out.println("Total " + daftarTanaman.size() + " data tanaman berhasil diexport.");
}
